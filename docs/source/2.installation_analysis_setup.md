...
1. Initialize the Brieflow submodule
   ...
   The brieflow submodule is already configured in this repository. Initialize it with:

   ```bash
   git submodule update --init --recursive
   ```

   This will clone the official [cheeseman-lab/brieflow](https://github.com/cheeseman-lab/brieflow) repository.

   **Optional**: If you want to use your own fork of brieflow instead:

   ```bash
   # Point the submodule to your fork before initializing
...
2. Point the submodule to your fork (in step 2.1 of Brieflow Setup):
