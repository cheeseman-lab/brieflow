...
To explore the test results in the [visualizer](https://brieflow.readthedocs.io/en/latest/4.visualization.html), run from `brieflow/tests/small_test_analysis`:
