...
Displays the experiment metadata from `screen.yaml` in your `analysis/` directory (a template ships with brieflow-analysis; see `tests/small_test_analysis/screen.yaml` for a filled-in example).
This includes:
