...
CONFIG_PATH = "/lab/cheeseman_ops/brieflow-screens/aconcagua-analysis/analysis/config/config.yml"

# Default path to the screen configuration file
SCREEN_PATH = os.getenv('BRIEFLOW_SCREEN_PATH', '../../screen.yaml')
SCREEN_PATH = "/lab/cheeseman_ops/brieflow-screens/aconcagua-analysis/screen.yaml"
...
def get_analysis_root_dir():
    ...
    return "/lab/cheeseman_ops/brieflow-screens/aconcagua-analysis/analysis/analysis_root"
