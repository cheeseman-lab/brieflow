...
missing_vacuoles = [col for col in required_vacuoles_cols if col not in vacuoles_df.columns]
...
print(f"Aggregation complete. Result has {len(result_df)} rows and {len(result_df.columns)} columns")
