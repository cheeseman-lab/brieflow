...
uniprot_data = expanded_df.sort_values(['gene_name', 'position']).drop_duplicates('gene_name', keep='first')
uniprot_data = uniprot_data[["gene_name", "uniprot_entry", "uniprot_function", "uniprot_link"]]
