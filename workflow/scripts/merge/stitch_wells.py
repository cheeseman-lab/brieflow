...
def process_modality_with_disk_offload(metadata_df, stitch_config, plate, well, data_type, params):
    """
...
def main():
    ...
    try:
        if 'temp_image_path' in results:
            ...
            print(f"✅ Saved cell positions: {outputs[2]} ({len(results['cell_positions'])} cells)")
