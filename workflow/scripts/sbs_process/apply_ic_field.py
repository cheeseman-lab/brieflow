...
aligned_segmentation_image = aligned_image_data[snakemake.params.segmentation_cycle - 1]

# load illumination correction field
ic_field = imread(snakemake.input[1])

# apply illumination correction field
corrected_image_data = apply_ic_field(aligned_segmentation_image, correction=ic_field)
