...
PHENOTYPE_TARGETS_ALL = (
    ...
    outputs_to_targets_with_combinations(
        PHENOTYPE_OUTPUTS["segment_phenotype"],
        PHENOTYPE_VALID_COMBINATIONS,
        PHENOTYPE_TILES
    ) +
    outputs_to_targets_with_combinations(
    ...
    outputs_to_targets_with_combinations(
        PHENOTYPE_OUTPUTS["merge_phenotype_cp"],
        PHENOTYPE_VALID_COMBINATIONS
    ) +
    # Evaluation targets (plate level only)
    outputs_to_targets_with_combinations(
        PHENOTYPE_OUTPUTS["eval_segmentation_phenotype"],
        [{"plate": combo["plate"]} for combo in PHENOTYPE_VALID_COMBINATIONS]
    ) +
    outputs_to_targets_with_combinations(
        PHENOTYPE_OUTPUTS["eval_features"],
        [{"plate": combo["plate"]} for combo in PHENOTYPE_VALID_COMBINATIONS]
    )
)
