...
class TestOMEZarrCompliance:
    ...
    def test_multiscale_metadata(self, temp_dir, sample_image_3d):
        ...
        for dataset in datasets:
            ...
            assert "coordinateTransformations" in dataset, (
                "Dataset missing coordinateTransformations"
            )
    ...
    def test_zarr_data_readable(self, temp_dir, sample_image_3d):
        ...
        np.testing.assert_array_equal(
            data, sample_image_3d, "Data mismatch after round-trip"
        )
    ...
    def test_multiple_images_compliance(
        self, temp_dir, sample_image_3d, sample_image_4d
    ):
...
class TestOMEZarrEdgeCases:
    ...
    def test_single_level_pyramid(self, temp_dir):
        ...
        assert detected_format is not None, (
            "Single-level pyramid failed format detection"
        )
